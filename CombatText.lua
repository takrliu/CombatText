...
function CombatText:OnFloaterLocationTargetClick( wndHandler, wndControl, eMouseButton )
	CreateDropdownMenu(self, wndControl:GetParent(), tFloaterLocations, "OnFloaterLocationTargetClick_item")
	wndControl:GetParent():FindChild("DropdownBox"):Show(true)
end

function CombatText:OnFloaterLocationTargetClick_item(wndHandler, wndControl, eMouseButton)
	settings.gen.eLocationTarget= wndControl:GetText()
...
function CombatText:OnFloaterLocationPlayerClick( wndHandler, wndControl, eMouseButton )
	CreateDropdownMenu(self, wndControl:GetParent(), tFloaterLocations, "OnFloaterLocationPlayerClick_item")
	wndControl:GetParent():FindChild("DropdownBox"):Show(true)
end

function CombatText:OnFloaterLocationPlayerClick_item(wndHandler, wndControl, eMouseButton)
	settings.gen.eLocationPlayer= wndControl:GetText()
	wndControl:GetParent():GetParent():GetParent():FindChild("DropDown"):SetText(wndControl:GetText())
	wndControl:GetParent():GetParent():Show(false)
end
